...
activities = {
    ...
    "Swimming Club": {
        "description": "Swimming lessons and competitive meets",
        "schedule": "Mondays and Wednesdays, 7:00 AM - 8:30 AM",
        "max_participants": 25,
    ...
    "Science Olympiad": {
        "description": "Team-based science competitions covering various STEM topics",
